...
var jSuites = function(options) {
    ...
    obj.setDictionary = function(d) {
        ...
        for (var i = 0; i < jSuites.calendar.weekDaysFull.length; i++) {
            t = jSuites.translate(jSuites.calendar.weekDaysFull[i]);
            if (t) {
                t = jSuites.calendar.weekDaysFull[i];
            }
        }
        ...
        for (var i = 0; i < jSuites.calendar.monthsFull.length; i++) {
            t = jSuites.translate(jSuites.calendar.monthsFull[i]);
            if (t) {
                jSuites.calendar.monthsFull[i] = t;
            }
        }
    }
...
jSuites.calendar = (function(el, options) {
    ...
    obj.setOptions = function(options, reset) {
        ...
        var defaults = {
            ...
            months: jSuites.calendar.months,
            monthsFull: jSuites.calendar.monthsFull,
            weekdays: jSuites.calendar.weekDaysFull,
        ...
        for (var i = 0; i < defaults.weekdays.length; i++) {
            var t = jSuites.translate(defaults.weekdays[i]);
            defaults.weekdays_short[i] = t.substr(0,1);
        }
...
jSuites.calendar.getDateString = function(value, options) {
    ...
    // Labels
    var weekdays = jSuites.calendar.weekDays;
    var weekDaysFull = jSuites.calendar.weekDaysFull;
    var months = jSuites.calendar.months;
    var monthsFull = jSuites.calendar.monthsFull;
    ...
    if (value) {
        ...
        if (d[0] && d[1] && d[2] && d[0] > 0 && d[1] > 0 && d[1] < 13 && d[2] > 0 && d[2] < 32) {
            ...
            replace('mmmm', monthsFull[calendar.getMonth()]);
            replace('mmm', months[calendar.getMonth()]);
...
jSuites.calendar.weekDays = [ 'Sun','Mon','Tue','Wed','Thu','Fri','Sat' ];
jSuites.calendar.weekDaysFull = [ 'Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday' ];
jSuites.calendar.months = [ 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec' ];
jSuites.calendar.monthsFull = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
...
jSuites.mask = (function() {
    ...
    obj.render = function(value, options, fullMask) {
        ...
        if (value instanceof Date || type =='datetime' || options.type == 'calendar') {
            ...
            if (typeof(value) === 'number') {
                ...
                if (options.mask && fullMask) {
                    ...
                    // Value
                    if (typeof(value) === 'number' && (''+value).match(/e/ig)) {
